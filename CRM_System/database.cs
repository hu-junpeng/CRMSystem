...
namespace CRM_System
{
    class database
    {
        ...
        private void open()
        {
            if(con==null)
            {
                string constr = @"server=MS-ACDUMUTWYQMD\HYMAN;database=CRM_database;user=sa;pwd=123456";
        ...
        public DataTable CovertDataReaderToDataTable(SqlDataReader datareader)
        {
